...
DoshiiResource.prototype = {
  ...
  constructRequest: function (requestData, callback) {
    return this.wrapTimeout(new Promise(((resolve, reject) => {
      ...
      this._request(requestData.method, requestData.supplimentHeaders, path.join(this._doshii.getApiField('version'), requestData.path), requestData.data, requestCallback)
    }).bind(this)), callback)
  },

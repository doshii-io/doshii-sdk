...
module.exports = DoshiiResource.extend({
  ...
  retrieveOne: function (data) {
    if (!data.memberId) throw new Error('Parameter \'memberId\' is required for the function \'Members.retrieveOne\'')
  ...
  update: function (data) {
    if (!data.memberId) throw new Error('Parameter \'memberId\' is required for the function \'Members.update\'')
  ...
  remove: function (data) {
    if (!data.memberId) throw new Error('Parameter \'memberId\' is required for the function \'Members.remove\'')

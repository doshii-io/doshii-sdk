...
module.exports = DoshiiResource.extend({
  ...
  retrieveOne: function (data) {
    if (!data.id) throw new Error('Parameter \'id\' is required for the function \'Reservations.retrieveOne\'')
  ...
  update: function (data) {
    if (!data.id) throw new Error('Parameter \'id\' is required for the function \'Reservations.update\'')
  ...
  remove: function (data) {
    if (!data.id) throw new Error('Parameter \'id\' is required for the function \'Reservations.remove\'')
  ...
  createCheckin: function (data) {
    if (!data.id) throw new Error('Parameter \'id\' is required for the function \'Reservations.createCheckin\'')
